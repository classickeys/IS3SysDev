...
<section class="filter_container">
    <section class="filter">
        <div class="carousel-container">
            <div class="carousel">
                <a href="searchProperties.php?search_term=<?php echo $searchTerm; ?>" id="filter-all">
                ...
                <a href="searchProperties.php?type=Houses&search_term=<?php echo $searchTerm; ?>" id="filter-houses">
                ...
                <a href="searchProperties.php?type=Bachelor%Properties&search_term=<?php echo $searchTerm; ?>" id="filter-bachelor">
                    <div class="carousel-item">
                ...
                <a href="searchProperties.php?type=Apartment%Properties&search_term=<?php echo $searchTerm; ?>" id="filter-apartment">
                    <div class="carousel-item">
                ...
                <a href="searchProperties.php?type=Cottage%Properties&search_term=<?php echo $searchTerm; ?>" id="filter-cottage">
                    <div class="carousel-item">
                ...
                <a href="searchProperties.php?type=Modern%Properties&search_term=<?php echo $searchTerm; ?>" id="filter-modern">
                    <div class="carousel-item">
                ...
                <a href="searchProperties.php?type=Furnished%Properties&search_term=<?php echo $searchTerm; ?>" id="filter-furnished">
                    <div class="carousel-item">
                ...
                <a href="searchProperties.php?type=Non-Furnished%Properties&search_term=<?php echo $searchTerm; ?>" id="filter-not-furnished">
                    <div class="carousel-item">
                ...
                <a href="searchProperties.php?type=Wifi%Properties&search_term=<?php echo $searchTerm; ?>" id="filter-wifi">
                    <div class="carousel-item">
                ...
                <a href="searchProperties.php?type=Water Backup%Properties&search_term=<?php echo $searchTerm; ?>" id="filter-waterbackup">
                    <div class="carousel-item">
    ...
    <section class="all-properties">
        <header>
            <h2><?php echo "Search Results for: " . strtoupper($searchTerm) . " - " . strtoupper($type); ?></h2>
        </header>
