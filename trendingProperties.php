...
<section class="filter_container">
    <section class="filter">
        <div class="carousel-container">
            ...
            <a href="trendingProperties.php?type=Houses">
            ...
            <a href="trendingProperties.php?type=Bachelor%Properties">
                <div class="carousel-item">
            ...
            <a href="trendingProperties.php?type=Apartment%Properties">
                <div class="carousel-item">
            ...
            <a href="trendingProperties.php?type=Cottage%Properties">
                <div class="carousel-item">
            ...
            <a href="trendingProperties.php?type=Modern%Properties">
                <div class="carousel-item">
            ...
            <a href="trendingProperties.php?type=Furnished%Properties">
                <div class="carousel-item">
            ...
            <a href="trendingProperties.php?type=Non-Furnished%Properties">
                <div class="carousel-item">
            ...
            <a href="trendingProperties.php?type=Wifi%Properties">
                <div class="carousel-item">
            ...
            <a href="trendingProperties.php?type=Water Backup%Properties">
                <div class="carousel-item">
    ...
    <section class="all-properties">
        <header>
            <h2><?php echo "Trending Properties -" . strtoupper($type); ?></h2>
        </header>
        <div class="row-container">
            <div class="image-container">
                ...
                //query result
                $query_img .= " ORDER BY ViewCount DESC"; //AccomodationID or Name ASC"
                ...
                if(empty($row)){
                    ...
                    echo "<h2> This filter produced no results. </h2>";
                    echo "</div>";
                }
